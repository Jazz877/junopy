...
class Msg(object):
    ...
    def AggregateExchangeRatePrevote(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/juno.oracle.v1.Msg/AggregateExchangeRatePrevote',
    ...
    def AggregateExchangeRateVote(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/juno.oracle.v1.Msg/AggregateExchangeRateVote',
    ...
    def DelegateFeedConsent(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/juno.oracle.v1.Msg/DelegateFeedConsent',
